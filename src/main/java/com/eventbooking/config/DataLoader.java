...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        User org1 = createUser("Mohammed", "Alami", "org1@event.ma", "organizer123", Role.ORGANIZER, "0612345678");
        User org2 = createUser("Fatima", "Bennani", "org2@event.ma", "organizer123", Role.ORGANIZER, "0623456789");
        User client1 = createUser("Youssef", "Idrissi", "client1@event.ma", "client123", Role.CLIENT, "0634567890");
        ...
        events.add(createEvent("Concert Saad Lamjarred", "Concert exceptionnel de la star marocaine",
                Categorie.CONCERT, LocalDateTime.now().plusDays(15), LocalDateTime.now().plusDays(15).plusHours(3),
        ...
        events.add(createEvent("Pièce: Le Bourgeois Gentilhomme", "Comédie-ballet de Molière",
                Categorie.THEATRE, LocalDateTime.now().plusDays(10), LocalDateTime.now().plusDays(10).plusHours(2),
        ...
        events.add(createEvent("Spectacle: Nass El Ghiwane", "Hommage au groupe mythique",
                Categorie.THEATRE, LocalDateTime.now().plusDays(20), LocalDateTime.now().plusDays(20).plusHours(3),
        ...
        events.add(createEvent("One Man Show: Gad Elmaleh", "Spectacle d'humour",
                Categorie.THEATRE, LocalDateTime.now().plusDays(45), LocalDateTime.now().plusDays(45).plusHours(2),
        ...
        events.add(createEvent("Tech Summit Morocco 2024", "Conférence sur les nouvelles technologies",
                Categorie.CONFERENCE, LocalDateTime.now().plusDays(25), LocalDateTime.now().plusDays(27),
        ...
        events.add(createEvent("Forum Économique Africain", "Rencontre des leaders économiques africains",
                Categorie.CONFERENCE, LocalDateTime.now().plusDays(40), LocalDateTime.now().plusDays(42),
        ...
        events.add(createEvent("Conférence sur l'IA", "Intelligence Artificielle et avenir",
                Categorie.CONFERENCE, LocalDateTime.now().plusDays(50), LocalDateTime.now().plusDays(50).plusHours(6),
        ...
        events.add(createEvent("Match Raja vs Wydad", "Derby casablancais",
                Categorie.SPORT, LocalDateTime.now().plusDays(7), LocalDateTime.now().plusDays(7).plusHours(2),
        ...
        events.add(createEvent("Marathon International de Marrakech", "Course de 42km à travers la ville rouge",
                Categorie.SPORT, LocalDateTime.now().plusDays(35), LocalDateTime.now().plusDays(35).plusHours(5),
    ...
    private void createReservation(User utilisateur, Event evenement, Integer nombrePlaces, StatutReservation statut) {
